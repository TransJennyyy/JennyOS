...
#include "NeededTools/Contribute.hpp"
char* RamDiskMgr::OverrideArray;
void* RamDiskMgr::OverrideAddr[NumberOverides];

void RamDiskMgr::init()
{
    OverrideArray = (char*)"/CommandLine.jexe\0/WatchDog.jexe\0/tl.jexe\0/help.jexe\0/contri.jexe\0"; 
    ...
    OverrideAddr[4] = (void*) Contribute::Entry;
}
